            ...
            <ErrorBanner
              ...
              children={
                <div>
                  ...
                  <p>If you have any questions, please contact us on <a className={css({ color: "primary", textDecoration: "underline" })} target="_blank" href="https://discord.gg/evrofinance">Discord</a> or <a className={css({ color: "primary", textDecoration: "underline" })} target="_blank" href="https://x.com">X</a>.</p>
                </div>
              }
            />
          )}
