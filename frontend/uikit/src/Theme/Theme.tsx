...
export const colors = {
	...
	// Evro brand colors
	"evro:pink": "#F5889B", // Evro brand pink/coral
	"evro:pinkLight": "#FFCDD2", // Light variant for hover states
	"evro:blue": "#7176ca", // Vivid blue for CTAs/links
	"evro:blueLight": "#9CB1F4", // Light variant
	"evro:purple": "#a081f5", // Medium purple accent
	"evro:orange": "#efa960", // Porsche orange accent
	"evro:shark": "#1d1c1f", // Shark dark (almost black)
	"evro:shark400": "#95929e", // Shark variant 400
	"evro:shark600": "#625e6b", // Shark variant 600
...
export const lightTheme = {
	name: "light" as const,
	colors: {
		accent: "evro:blue", // #7176ca (vivid blue for CTAs/buttons)
		accentActive: "blue:600",
		accentContent: "white",
		accentHint: "blue:400",
		background: "evro:pageBackground",
		...
		evroBorrowBackground: "evro:background",
		evroBorrowBackgroundContent: "white",
		evroBorrowBackgroundContentAlt: "evro:shark600",
